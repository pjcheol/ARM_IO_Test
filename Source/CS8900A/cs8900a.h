...
#define CONFIG_BOOTCOMMAND	"tftp 30800000 disk_LN2410;tftp 0x30f00000 zImage_LN2410;go 0x30f00000"

#define CS8900_BASE	0x08000300
#define CS8900_REG U16
#define CS8900_OFF 0x02
#define CS8900_BUS16_0  00//*(volatile U8 *)(CS8900_BASE+0x00)
#define CS8900_BUS16_1  01//*(volatile U8 *)(CS8900_BASE+0x01)

#define CS8900_RTDATA 0//*(volatile CS8900_REG *)(CS8900_BASE+0x00*CS8900_OFF)
#define CS8900_TxCMD  4//*(volatile CS8900_REG *)(CS8900_BASE+0x02*CS8900_OFF)
#define CS8900_TxLEN  6//*(volatile CS8900_REG *)(CS8900_BASE+0x03*CS8900_OFF)
#define CS8900_ISQ    8//*(volatile CS8900_REG *)(CS8900_BASE+0x04*CS8900_OFF)
#define CS8900_PPTR   10//*(volatile CS8900_REG *)(CS8900_BASE+0x05*CS8900_OFF)
#define CS8900_PDATA  12//*(volatile CS8900_REG *)(CS8900_BASE+0x06*CS8900_OFF)
...
extern U8		NetOurEther[6];		
extern U8		NetServerEther[6];	
extern IPaddr_t		NetOurIP;		
extern IPaddr_t		NetServerIP;		
extern volatile U8 * NetTxPacket;		
extern volatile U8 * NetRxPackets[PKTBUFSRX];
extern volatile U8 * NetRxPkt;		
extern S32		NetRxPktLen;		
extern unsigned		NetIPID;		
extern U8		NetBcastAddr[6];	

extern void	NetReceive(volatile U8 *, S32);

extern S32 cs8900_e2prom_read(U8, U16 *);
extern S32 cs8900_e2prom_write(U8, U16);
...
S32 eth_rx (volatile void *packet);
extern S32 eth_send (volatile void *packet, S32 length);
U16 get_reg_init_bus (int regno);
U32 simple_strtoul(S8 *p, S8 **out_p, S32 base);
